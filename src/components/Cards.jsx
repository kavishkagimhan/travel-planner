        ...
        <div className='w-full py-[10rem] px-4 bg-white '>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 sm:px-4'>
                <div className='flex flex-col w-full p-4 my-4 duration-300 rounded-lg shadow-xl hover:scale-105'>
                    ...
                    <h2 className='py-8 text-2xl font-bold text-center'>1 Month</h2>
                    ...
                    <button className='bg-blue-400 w-[200px] rounded-md font-medium my-6 mx-auto text-black py-3 '>Start trail</button>
                </div>
                <div className='flex flex-col w-full p-4 my-4 duration-300 bg-gray-100 rounded-lg shadow-xl hover:scale-105'>
                    ...
                    <h2 className='py-8 text-2xl font-bold text-center'>1 Year</h2>
                    ...
                    <button className='text-blue-400 w-[200px] rounded-md font-medium my-6 mx-auto bg-black py-3 '>Start trail</button>
                </div>
                <div className='flex flex-col w-full p-4 my-4 duration-300 rounded-lg shadow-xl hover:scale-105'>
                    <img className='w-20 mx-auto mt-[-3rem] bg-white ' src={Triple} alt="" />
                    <h2 className='py-8 text-2xl font-bold text-center'>2 Year</h2>
