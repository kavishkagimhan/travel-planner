    ...
    <div className='relative top-0 z-0 flex items-center justify-center h-screen bg-center bg-cover bg-none' style={{
      ...
      <div className='flex items-center justify-start w-1/2 mx-auto -mt-10 bg-gray-300 rounded-md h-1/2'>
        <div className='w-[50%] ml-10'>
          <h2 className='mb-4 text-4xl font-semibold text-black uppercase'>LogIn</h2>
          ...
          <button className='bg-blue-400 text-white px-6 py-1 rounded-lg text-xl hover:text-green-500 hover:bg-white mt-[20px]'onClick={onLogin}>
            LogIn
          </button>
